...
// Intern-facing "Apply Leave" form. Same Leave model/Leaves provider as the
// staff module's LeaveFormScreen, but styled with the intern module's own
// teal palette instead of the staff indigo theme.
class InternApplyLeaveScreen extends StatefulWidget {
  final int staffId;

  const InternApplyLeaveScreen({
    super.key,
    required this.staffId,
  });

  @override
  State<InternApplyLeaveScreen> createState() =>
      _InternApplyLeaveScreenState();
}

class _InternApplyLeaveScreenState extends State<InternApplyLeaveScreen> {
  ...
  // Intern UI Color Palette (Teal & Slate), matching the intern dashboard
  final Color internPrimary = const Color(0xFF0F766E);
  final Color internBg = const Color(0xFFF8FAFC);
              ...
              children: [
                ...
                ListTile(
                  leading: Container(
                    ...
                    decoration: BoxDecoration(
                        color: internPrimary.withOpacity(0.1),
                        shape: BoxShape.circle),
                    child:
                        Icon(Icons.photo_library_rounded, color: internPrimary),
                  ),
  ...
  InputDecoration _buildInputDecoration(String label, IconData icon) {
    return InputDecoration(
      ...
      prefixIcon: Icon(icon, color: internPrimary.withOpacity(0.7), size: 22),
      filled: true,
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: BorderSide(color: internPrimary, width: 2),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: internBg,
      appBar: AppBar(
        elevation: 0,
        backgroundColor: internPrimary,
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: TextFormField(
                        decoration: _buildInputDecoration(
                          ...
                          suffixIcon: Icon(Icons.calendar_today_rounded,
                              color: internPrimary.withOpacity(0.7)),
                        ),
                        controller: TextEditingController(
                          text: _endDate == null
                              ? ''
                  ...
                  DropdownButtonFormField<String>(
                    decoration: _buildInputDecoration(
                        proofLabel, Icons.attachment_rounded),
                    icon: Icon(Icons.keyboard_arrow_down_rounded,
                        color: internPrimary),
                      ...
                      children: [
                        ...
                        OutlinedButton.icon(
                          ...
                          style: OutlinedButton.styleFrom(
                            foregroundColor: internPrimary,
                            side: BorderSide(color: internPrimary),
