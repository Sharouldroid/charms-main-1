...
class RSSReport extends StatefulWidget {
  const RSSReport({
    super.key,
    required this.staff,
    required this.user,
  ...
  @override
  State<RSSReport> createState() => _RSSReportState();
}

class _RSSReportState extends State<RSSReport> {
  @override
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Researcher Special Slot Report'),
          ...
          children: [
            ...
            FutureBuilder(
              future: Provider.of<Reports>(context, listen: false)
                  .fetchMonthlyReport(widget.hostname, 'rss'),
            ...
            FutureBuilder(
              future: Provider.of<Reports>(context, listen: false)
                  .fetchYearlyReport(widget.hostname, 'rss'),
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return const Center(child: CircularProgressIndicator());
                } else {
