...
import 'package:charms/widgets/volunteer/group_booking.dart';
...
class _BookSlotState extends State<BookSlot> {
  ...
  void _showBookDialog(List<int> ischecked) {
    showDialog(
      context: context,
  ...
  Future<void> _submit(List<int> ischecked) async {
    ...
    // 2. Add Item to Cart (Existing logic)
                    ...
                    child: Consumer2<Indemnitites, StripeService>(
                      builder: (context, providerA, providerB, child) {
                        return ElevatedButton.icon(
                          ...
                          onPressed: _isFormValid ? () => _submit(ischecked) : null,
                          style: ElevatedButton.styleFrom(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          // Replaced Initial Text Field with CheckboxListTile
          CheckboxListTile(
            title: const Text(
            ...
            controlAffinity: ListTileControlAffinity.trailing, // Box on the right
