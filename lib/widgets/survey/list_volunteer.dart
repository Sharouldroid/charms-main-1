...
class _ListVolunteerState extends State<ListVolunteer> {
  ...
  void initState() {
    ...
    _loadDataFuture = Provider.of<Surveys>(context, listen: false)
        .fetchBookedbyId(widget.hostname, widget.eventid);
  }
        ...
        return Consumer<Surveys>(
          builder: (context, surveyData, child) {
            ...
            return ListView.builder(
              shrinkWrap: true,
              itemCount: surveyData.vollist.length,
              itemBuilder: (context, index) {
                final volunteer = surveyData.vollist[index];
                return Card(
                  margin:
