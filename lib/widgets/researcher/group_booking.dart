...
class ResearcherGroupBooking extends StatefulWidget {
  const ResearcherGroupBooking({
    super.key,
    required this.pax,
    required this.user,
  ...
  @override
  State<ResearcherGroupBooking> createState() => _ResearcherGroupBookingState();
}

class _ResearcherGroupBookingState extends State<ResearcherGroupBooking> {
              ...
              onPressed: () {
                ...
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (ctx) => IndemnityScreen(
                          ...
                          staff: widget.staff,
                          volres: 2,
                          diet: 'None', // <--- FIXED: Added missing diet argument
                          health: 'No health issue',
                        )));
              },
