...
class GroupSpecialBooking extends StatefulWidget {
  const GroupSpecialBooking({
    super.key,
    required this.pax,
    required this.user,
  ...
  @override
  State<GroupSpecialBooking> createState() => _GroupSpecialBookingState();
}

class _GroupSpecialBookingState extends State<GroupSpecialBooking> {
                ...
                onPressed: () {
                  ...
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (ctx) => SpecialIndemnityScreen(
                            ...
                            affiliatetitle: widget.affiliatetitle,
